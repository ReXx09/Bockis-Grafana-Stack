...
function restoreLog(){const entries=JSON.parse(localStorage.getItem(logStorageKey)||'[]');if(!Array.isArray(entries)||!entries.length)return;document.getElementById('live-log').textContent=entries.join('\n')+'\n'}
