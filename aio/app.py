...
function logEvent(message){const log=document.getElementById('live-log');const time=new Date().toLocaleTimeString('de-DE');if(log.textContent==='Noch keine Aktionen.')log.textContent='';log.textContent+=`[${time}] ${message}\n`;log.scrollTop=log.scrollHeight}
